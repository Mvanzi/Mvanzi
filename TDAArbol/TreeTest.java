...
public class TreeTest {
	...
	public void children() {
		...
		Position<Integer> p;
		int i = 1;
		Queue<Position<Integer>> cola = new ColaConPila<Position<Integer>>();
		try {
			p = T.root();
	...
	public void addBefore() {
		...
		try {
			...
			hijosH1 = new Lista_doble_enlazada<Integer>();
			hijosH1.addFirst(4);
			hijosH1.addFirst(5);
			hjsH1 = new Lista_doble_enlazada<Integer>();
	...
	public void addAfter() {
		...
		try {
			...
			chequearPadre(T.root());
			// caso de prueba para los hijos de root
			PositionList<Integer> hijosRoot = new Lista_doble_enlazada<Integer>();
			hijosRoot.addFirst(2);
			hijosRoot.addFirst(7);
			hijosRoot.addFirst(3);
			hijosRoot.addFirst(6);
			hijosRoot.addFirst(9);
			PositionList<Integer> hijos = new Lista_doble_enlazada<Integer>();
			for (Position<Integer> n : T.children(T.root())) {
	...
	public void removeInternal() {
		...
		lista = new Lista_doble_enlazada<Integer>();
		for (i = 1; i <= 12; i++)
			lista.addLast(i);
		...
		try {
			...
			for (i = 1; i <= 4; i++)
				lista.addLast(i);
			p1 = (Position<Integer>) lista.last();
			lista.addLast(9);
			lista.addLast(10);
			p = (Position<Integer>) lista.last();
			for (i = 6; i <= 8; i++)
				lista.addLast(i);
			p2 = (Position<Integer>) lista.last();
			lista.addLast(12);
			lista.addLast(11);
			chequearHijosNiveles2(lista);
			// elimino el nodo 12
	...
	public void remove() {
		...
		T = getTree();
		cargarArbol2(T);
		lista = new Lista_doble_enlazada<Position<Integer>>();
		try {
