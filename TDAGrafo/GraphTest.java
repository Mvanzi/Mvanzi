 ...
 * 
 * @author Gonzalo Ezequiel Arro - Departamento de Ciencias e Ingenieri�a de la
 *         Computacion - Universidad Nacional del Sur - gonzalo.arro@hotmail.com
 * 
...
public class GraphTest {
	...
	//	graph = new GrafoMatriz<Object, Object>(105); // cambiar esta li�nea para probar
		 graph = new GrafoMatriz<Object, Object>(50); // cambiar esta li�nea
		// para probar
	 ...
	 * con un i�nico arco entre ellos.
	 */
	@Test
	...
	public void insertVertex_emptyGraph_newVertexInGraph() throws InvalidVertexException {
		...
		assertFalse(
				"Luego de insertar un i�nico vertice, el metodo vertices retorna una coleccion con mi�s de un elemento.",
				verticesIterator.hasNext());
	}
	...
	public void insertEdge_emptyGraph_newEdgeInGraph() throws InvalidVertexException, InvalidEdgeException {
		...
		assertFalse("Luego de insertar un i�nico arco, el metodo edges retorna una coleccion con mi�s de un elemento.",
				edgesIterator.hasNext());
	}
	...
	public void removeVertex_validVertex_removedFromVerticesList() throws InvalidVertexException {
		...
		Iterator<Vertex<Object>> verticesIterator = vertices.iterator();
		assertFalse(
				"El metodo vertices no retorna una coleccion iterable vaci�a luego de eliminar el i�nico vertice del grafo.",
				verticesIterator.hasNext());
	}
	...
	public void removeVertex_vertexWithEdge_removedEdge() throws InvalidVertexException, InvalidEdgeException {
		...
		Iterator<Edge<Object>> edgesIterator = edges.iterator();
		assertFalse(
				"El metodo edges no retorna una coleccion iterable vaci�a luego de eliminar el vertice que teni�a el i�nico arco del grafo.",
				edgesIterator.hasNext());
	}
	...
	public void removeEdge_validEdge_removedFromEdgesList() throws InvalidVertexException, InvalidEdgeException {
		...
		Iterator<Edge<Object>> edgesIterator = edges.iterator();
		assertFalse(
				"El metodo edges no retorna una coleccion iterable vaci�a luego de eliminar el i�nico arco del grafo mediante removeEdge.",
				edgesIterator.hasNext());
	}
